...
CREATE TABLE IF NOT EXISTS `breizhvideo`.`preference` (
  ...
  CONSTRAINT `fk_preference_show1`
    ...
    REFERENCES `breizhvideo`.`show` (`idshow`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
CREATE TABLE IF NOT EXISTS `breizhvideo`.`film_category` (
  `idfilm_category` INT NOT NULL AUTO_INCREMENT,
  `film_film_id` SMALLINT UNSIGNED NOT NULL,
  `category_category_id` TINYINT UNSIGNED NOT NULL,
  PRIMARY KEY (`idfilm_category`),
